...
if __name__ == "__main__":
    ...
    soup = BeautifulSoup(response.text, 'html.parser') # đưa về html
    ...
    if table:
        tbody = table.find('tbody') # tìm thẻ 'tbody'
        if tbody:
    ...
    print("Đã lưu thông tin  giá các cầu thủ vào file results3.csv")
